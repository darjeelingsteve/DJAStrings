...
extension LocalisationGroupTests {
    ...
    func testItProducesTheCorrectPlaceholdersForDeviceVariedLocalisationsWithPluralisedVariations() throws {
        ...
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].placeholders.count, 0)
        
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[0].localisations[0].key, "device.messages.cta")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[0].localisations[0].placeholders.count, 1)
        XCTAssertNil(localisationGroup.childGroups[0].childGroups[0].localisations[0].placeholders[0].name)
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[0].localisations[0].placeholders[0].type, .integer)
        
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].key, "device.messages_and_inbox_count.cta")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].placeholders.count, 2)
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].placeholders[0].name, "message_count")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].placeholders[0].type, .integer)
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].placeholders[1].name, "inbox_count")
...
extension LocalisationGroupTests {
    ...
    func testItGeneratesTheCorrectPreviewsForDeviceVaryingLocalisations() throws {
        ...
        try whenAParsedStringsDocumentIsApplied(withFilename: "Namespace-keyed Device-varied Localisations")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[0].localisations[0].key, "device.messages.cta")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[0].localisations[0].previews.count, 3)
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[0].localisations[0].previews[0].description, "Device iPod, One")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[0].localisations[0].previews[0].value, "Tap to view your %d message.")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[0].localisations[0].previews[1].description, "Device iPod, Other")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[0].localisations[0].previews[1].value, "Tap to view your %d messages.")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[0].localisations[0].previews[2].description, "Device Other")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[0].localisations[0].previews[2].value, "Tap to view your %d messages.")
        
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].key, "device.messages_and_inbox_count.cta")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews.count, 8)
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[0].description, "Device Mac, messageCount One, inboxCount One")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[0].value, "Click to view your `messageCount` message in `inboxCount` inbox.")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[1].description, "Device Mac, messageCount One, inboxCount Other")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[1].value, "Click to view your `messageCount` message in `inboxCount` inboxes.")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[2].description, "Device Mac, messageCount Other, inboxCount One")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[2].value, "Click to view your `messageCount` messages in `inboxCount` inbox.")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[3].description, "Device Mac, messageCount Other, inboxCount Other")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[3].value, "Click to view your `messageCount` messages in `inboxCount` inboxes.")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[4].description, "Device Other, messageCount One, inboxCount One")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[4].value, "Tap to view your `messageCount` message in `inboxCount` inbox.")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[5].description, "Device Other, messageCount One, inboxCount Other")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[5].value, "Tap to view your `messageCount` message in `inboxCount` inboxes.")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[6].description, "Device Other, messageCount Other, inboxCount One")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[6].value, "Tap to view your `messageCount` messages in `inboxCount` inbox.")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[7].description, "Device Other, messageCount Other, inboxCount Other")
        XCTAssertEqual(localisationGroup.childGroups[0].childGroups[1].localisations[0].previews[7].value, "Tap to view your `messageCount` messages in `inboxCount` inboxes.")
        
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].key, "device.tap")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews.count, 7)
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[0].description, "Device iPhone")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[0].value, "Tap your iPhone")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[1].description, "Device iPod")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[1].value, "Tap your iPod")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[2].description, "Device iPad")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[2].value, "Tap your iPad")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[3].description, "Device Apple Watch")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[3].value, "Tap your Apple Watch")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[4].description, "Device Apple TV")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[4].value, "Click your Apple TV")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[5].description, "Device Mac")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[5].value, "Click your Mac")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[0].previews[6].description, "Device Other")
