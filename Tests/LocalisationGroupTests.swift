...
extension LocalisationGroupTests {
    ...
    func testItGeneratesTheCorrectLocalisedValuesForPluralisedLocalisations() throws {
        ...
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[0].description, "message_count Zero, inbox_count Zero")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[0].value, "You have no messages across no inboxes")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[1].description, "message_count Zero, inbox_count One")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[1].value, "You have no messages across `inbox_count` inbox")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[2].description, "message_count Zero, inbox_count Other")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[2].value, "You have no messages across `inbox_count` inboxes")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[3].description, "message_count One, inbox_count Zero")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[3].value, "You have `message_count` message across no inboxes")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[4].description, "message_count One, inbox_count One")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[4].value, "You have `message_count` message across `inbox_count` inbox")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[5].description, "message_count One, inbox_count Other")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[5].value, "You have `message_count` message across `inbox_count` inboxes")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[6].description, "message_count Other, inbox_count Zero")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[6].value, "You have `message_count` messages across no inboxes")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[7].description, "message_count Other, inbox_count One")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[7].value, "You have `message_count` messages across `inbox_count` inbox")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[8].description, "message_count Other, inbox_count Other")
        XCTAssertEqual(localisationGroup.childGroups[0].localisations[1].previews[8].value, "You have `message_count` messages across `inbox_count` inboxes")
    }
    ...
    func testItGeneratesTheCorrectLocalisedValuesForVariableWidthLocalisations() throws {
        ...
        XCTAssertEqual(localisationGroup.localisations[1].previews[0].description, "Width 20, message_count_20 Zero, inbox_count_20 Zero")
        XCTAssertEqual(localisationGroup.localisations[1].previews[0].value, "No msgs in no boxes.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[1].description, "Width 20, message_count_20 Zero, inbox_count_20 One")
        XCTAssertEqual(localisationGroup.localisations[1].previews[1].value, "No msgs in `inbox_count_20` box.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[2].description, "Width 20, message_count_20 Zero, inbox_count_20 Other")
        XCTAssertEqual(localisationGroup.localisations[1].previews[2].value, "No msgs in `inbox_count_20` boxes.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[3].description, "Width 20, message_count_20 One, inbox_count_20 Zero")
        XCTAssertEqual(localisationGroup.localisations[1].previews[3].value, "`message_count_20` msg in no boxes.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[4].description, "Width 20, message_count_20 One, inbox_count_20 One")
        XCTAssertEqual(localisationGroup.localisations[1].previews[4].value, "`message_count_20` msg in `inbox_count_20` box.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[5].description, "Width 20, message_count_20 One, inbox_count_20 Other")
        XCTAssertEqual(localisationGroup.localisations[1].previews[5].value, "`message_count_20` msg in `inbox_count_20` boxes.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[6].description, "Width 20, message_count_20 Other, inbox_count_20 Zero")
        XCTAssertEqual(localisationGroup.localisations[1].previews[6].value, "`message_count_20` msgs in no boxes.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[7].description, "Width 20, message_count_20 Other, inbox_count_20 One")
        XCTAssertEqual(localisationGroup.localisations[1].previews[7].value, "`message_count_20` msgs in `inbox_count_20` box.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[8].description, "Width 20, message_count_20 Other, inbox_count_20 Other")
        XCTAssertEqual(localisationGroup.localisations[1].previews[8].value, "`message_count_20` msgs in `inbox_count_20` boxes.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[9].description, "Width 70, message_count_70 Zero, inbox_count_70 Zero")
        XCTAssertEqual(localisationGroup.localisations[1].previews[9].value, "You have no messages in no inboxes.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[10].description, "Width 70, message_count_70 Zero, inbox_count_70 One")
        XCTAssertEqual(localisationGroup.localisations[1].previews[10].value, "You have no messages in `inbox_count_70` inbox.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[11].description, "Width 70, message_count_70 Zero, inbox_count_70 Other")
        XCTAssertEqual(localisationGroup.localisations[1].previews[11].value, "You have no messages in `inbox_count_70` inboxes.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[12].description, "Width 70, message_count_70 One, inbox_count_70 Zero")
        XCTAssertEqual(localisationGroup.localisations[1].previews[12].value, "You have `message_count_70` message in no inboxes.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[13].description, "Width 70, message_count_70 One, inbox_count_70 One")
        XCTAssertEqual(localisationGroup.localisations[1].previews[13].value, "You have `message_count_70` message in `inbox_count_70` inbox.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[14].description, "Width 70, message_count_70 One, inbox_count_70 Other")
        XCTAssertEqual(localisationGroup.localisations[1].previews[14].value, "You have `message_count_70` message in `inbox_count_70` inboxes.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[15].description, "Width 70, message_count_70 Other, inbox_count_70 Zero")
        XCTAssertEqual(localisationGroup.localisations[1].previews[15].value, "You have `message_count_70` messages in no inboxes.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[16].description, "Width 70, message_count_70 Other, inbox_count_70 One")
        XCTAssertEqual(localisationGroup.localisations[1].previews[16].value, "You have `message_count_70` messages in `inbox_count_70` inbox.")
        XCTAssertEqual(localisationGroup.localisations[1].previews[17].description, "Width 70, message_count_70 Other, inbox_count_70 Other")
        XCTAssertEqual(localisationGroup.localisations[1].previews[17].value, "You have `message_count_70` messages in `inbox_count_70` inboxes.")
    }
}
