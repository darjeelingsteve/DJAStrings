...
extension LocalisationGroupTests {
    ...
    func testItGeneratesTheCorrectLocalisedValuesForVariableWidthLocalisations() throws {
        ...
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues.count, 18)
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[0].description, "Width 20, message_count_20 Zero, inbox_count_20 Zero")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[0].value, "No msgs in no boxes.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[1].description, "Width 20, message_count_20 Zero, inbox_count_20 One")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[1].value, "No msgs in `inbox_count_20` box.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[2].description, "Width 20, message_count_20 Zero, inbox_count_20 Other")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[2].value, "No msgs in `inbox_count_20` boxes.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[3].description, "Width 20, message_count_20 One, inbox_count_20 Zero")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[3].value, "`message_count_20` msg in no boxes.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[4].description, "Width 20, message_count_20 One, inbox_count_20 One")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[4].value, "`message_count_20` msg in `inbox_count_20` box.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[5].description, "Width 20, message_count_20 One, inbox_count_20 Other")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[5].value, "`message_count_20` msg in `inbox_count_20` boxes.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[6].description, "Width 20, message_count_20 Other, inbox_count_20 Zero")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[6].value, "`message_count_20` msgs in no boxes.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[7].description, "Width 20, message_count_20 Other, inbox_count_20 One")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[7].value, "`message_count_20` msgs in `inbox_count_20` box.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[8].description, "Width 20, message_count_20 Other, inbox_count_20 Other")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[8].value, "`message_count_20` msgs in `inbox_count_20` boxes.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[9].description, "Width 70, message_count_70 Zero, inbox_count_70 Zero")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[9].value, "You have no messages in no inboxes.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[10].description, "Width 70, message_count_70 Zero, inbox_count_70 One")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[10].value, "You have no messages in `inbox_count_70` inbox.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[11].description, "Width 70, message_count_70 Zero, inbox_count_70 Other")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[11].value, "You have no messages in `inbox_count_70` inboxes.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[12].description, "Width 70, message_count_70 One, inbox_count_70 Zero")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[12].value, "You have `message_count_70` message in no inboxes.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[13].description, "Width 70, message_count_70 One, inbox_count_70 One")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[13].value, "You have `message_count_70` message in `inbox_count_70` inbox.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[14].description, "Width 70, message_count_70 One, inbox_count_70 Other")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[14].value, "You have `message_count_70` message in `inbox_count_70` inboxes.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[15].description, "Width 70, message_count_70 Other, inbox_count_70 Zero")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[15].value, "You have `message_count_70` messages in no inboxes.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[16].description, "Width 70, message_count_70 Other, inbox_count_70 One")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[16].value, "You have `message_count_70` messages in `inbox_count_70` inbox.")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[17].description, "Width 70, message_count_70 Other, inbox_count_70 Other")
        XCTAssertEqual(localisationGroup.localisations[1].localisedValues[17].value, "You have `message_count_70` messages in `inbox_count_70` inboxes.")
    }
}
