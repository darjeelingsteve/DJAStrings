...
extension XCStringsDocumentTests {
    func testItLoadsAPluralisedLocalisationsStringsFile() throws {
        ...
        XCTAssertEqual(stringsDocument.orderedStringKeys[1], "You have %1$d messages across %2$d inboxes")
        XCTAssertEqual(stringsDocument.orderedStringKeys[2], "You have %d new messages")
        ...
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["en"]?.variations?.plural?.zero?.stringUnit?.state, .translated)
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["en"]?.variations?.plural?.zero?.stringUnit?.value, "You have no new messages")
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["en"]?.variations?.plural?.one?.stringUnit?.state, .translated)
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["en"]?.variations?.plural?.one?.stringUnit?.value, "You have %d new message")
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["en"]?.variations?.plural?.other.stringUnit?.state, .new)
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["en"]?.variations?.plural?.other.stringUnit?.value, "You have %d new messages")
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["fr"]?.variations?.plural?.zero?.stringUnit?.state, .translated)
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["fr"]?.variations?.plural?.zero?.stringUnit?.value, "Vous n'avez pas de nouveaux messages")
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["fr"]?.variations?.plural?.one?.stringUnit?.state, .translated)
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["fr"]?.variations?.plural?.one?.stringUnit?.value, "Vous avez %d nouveau message")
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["fr"]?.variations?.plural?.other.stringUnit?.state, .translated)
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["fr"]?.variations?.plural?.other.stringUnit?.value, "Vous avez %d nouveaux messages")
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["de"]?.variations?.plural?.zero?.stringUnit?.state, .translated)
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["de"]?.variations?.plural?.zero?.stringUnit?.value, "Sie haben keine neuen Nachrichten")
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["de"]?.variations?.plural?.one?.stringUnit?.state, .translated)
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["de"]?.variations?.plural?.one?.stringUnit?.value, "Sie haben %d neue Nachricht")
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["de"]?.variations?.plural?.other.stringUnit?.state, .translated)
        XCTAssertEqual(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.localisations?["de"]?.variations?.plural?.other.stringUnit?.value, "Sie haben %d neue Nachrichten")
        XCTAssertNil(stringsDocument.strings[stringsDocument.orderedStringKeys[2]]?.comment)
    }
}
